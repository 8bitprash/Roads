...
export default function Home() {
  return (
    <>
      <Head>
        <title>Roads - Share thoughts and stories with friends worldwide, on your time.</title>
      ...
      <main className={`${styles.main}`}>
        ...
        <Hero 
          ...
          subtitle="Connect with friends worldwide, at your convenience, to share thoughts and stories seamlessly across time zones."
        />
